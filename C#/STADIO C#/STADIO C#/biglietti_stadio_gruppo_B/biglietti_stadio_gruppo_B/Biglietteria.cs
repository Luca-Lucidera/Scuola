...
namespace biglietti_stadio_gruppo_B
{
    public class Biglietteria
    {
        ...
        public int cercaBigliettoTornaPosizione(string da_trovare)
        {
            for (int i = 0; i < v.Count; i++)
            {
                if (da_trovare == (v.ElementAt(i).getEvento() + " " + v.ElementAt(i).getNumBiglietto()))
                {
                    return i;//ritorna posizione
                }
            }
            return -1;
        }
        ...
        public void reInserisciUnPosto(string posizione,int posto,string evento)
        {
            for (int i = 0; i < eventi.Count; i++)
            {
                if (eventi.ElementAt(i).getNome() == evento)
                {
                    if (i == 0)
                    {
                        if (posizione == "ERBA")
                        {
                              postiErba.ElementAt(posto);
                        }
                        else if (posizione == "1° CERCHIO")
                        {
                              postiPrimoCerchio.ElementAt(posto);
                        }
                        else if (posizione == "2° CERCHIO")
                        {
                             postiSecondoCerchio.ElementAt(posto);
                        }
                        else if (posizione == "3° CERCHIO")
                        {
                             postiTerzoCerchio.ElementAt(posto);
                        }
                    }
                    else if (i == 1)
                    {
                        if (posizione == "ERBA")
                        {
                             postiErbaSecondoEvento.ElementAt(posto);
                        }
                        else if (posizione == "1° CERCHIO")
                        {
                             postiPrimoCerchioSecondoEvento.ElementAt(posto);
                        }
                        else if (posizione == "2° CERCHIO")
                        {
                             postiSecondoCerchioSecondoEvento.ElementAt(posto);
                        }
                        else if (posizione == "3° CERCHIO")
                        {
                             postiTerzoCerchioSecondoEvento.ElementAt(posto);
                        }
                    }
                    else if (i == 2)
                    {
                        if (posizione == "ERBA")
                        {
                             postiErbaTerzoEvento.ElementAt(posto);
                        }
                        else if (posizione == "1° CERCHIO")
                        {
                             postiPrimoCerchioTerzoEvento.ElementAt(posto);
                        }
                        else if (posizione == "2° CERCHIO")
                        {
                             postiSecondoCerchioTerzoEvento.ElementAt(posto);
                        }
                        else if (posizione == "3° CERCHIO")
                        {
                             postiTerzoCerchioTerzoEvento.ElementAt(posto);
                        }
                    }
                }
            }
        }
        public void ModificaBiglietto(Biglietto b,int pos)
        {
            v.RemoveAt(pos);
            v.Add(b);
        }
